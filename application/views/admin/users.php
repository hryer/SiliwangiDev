      ...
      <div class="container">
        <div class="row" >
          ...
          <div class="col-md-8">
            ...
            <div class="row">
              <div class="col-md-6">
                 <h1 class="page-header text-primary"><i class="glyphicon glyphicon-user"></i> Users</h1> 
                </div>
              <div class="col-md-6">
            ...
            <table id="sort-table" class="table table-striped table-sorter">
              ...
              <tr class="text-info">
                ...
                <th>Fullname   <i class="glyphicon    glyphicon-chevron-down"></i>  </th>
              ...
              <tr>
                ...
                <td><a href="user.html">Harry Ermawan</a></td>
                <td>har@mail.com</td>
                <td>Admin</td>
              </tr>
              <tr>
                <td><input type="checkbox"></td>
                <td><a href="user.html">Shim Ermawan</a></td>
                <td>har@mail.com</td>
                <td>CustomerService</td>
              </tr>
              <tr>
                <td><input type="checkbox"></td>
                <td><a href="user.html">Riot Ermawan</a></td>
                <td>Web Design</td>
                <td>Freelance</td>
              </tr>
